...
These are the existing rules that are run against items:
...
Feature Requirement:
  ...
  - Once the sell by date of "Baked" items has passed they will degrade twice as fast as they normally do.
...
* All projects include functional working unit tests. You can run these unit tests and modify, extend, or add new tests as you see fit.
